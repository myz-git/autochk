...
func Ana_DBShpSize(rule *utils.RuleInfo, instshtp *structs.InstShts, summaryEntries *structs.SummaryEntries) {
	// entry := structs.SummaryEntry{
	// 	Category: "实例分析",
...
func Ana_DBShpPct(rule *utils.RuleInfo, instshtp *structs.InstShts, summaryEntries *structs.SummaryEntries) {
